...
void MeasuresWireDimensions()
{
    ...
    const Wire straightSpline = Wire::CubicBSpline({
        {0.0, 0.0, 0.0}, {2.0, 0.0, 0.0}, {5.0, 0.0, 0.0},
        {8.0, 0.0, 0.0}, {10.0, 0.0, 0.0},
    });
    RequireNear(MeasureWireLength(straightSpline), 10.0, 1.0e-6, "B-spline length");
    Require(
        AlmostEqual(MeasureWireTangent(straightSpline, 0.4), {1.0, 0.0, 0.0}, 1.0e-7),
        "B-spline tangent");
