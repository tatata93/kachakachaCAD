...
| WP-14 | 進行中(Codex, `codex/v2-ui-ux-overhaul`, 2026-09-12。Phase 1 操作基盤) | WP-08 | 統合UI/UX、選択、カーソル、スナップ、ToolSession、プロパティ、プレビュー、画面復元 |
...
- **オーナーの明示の指示。** 2026-09-09 に「V2が満足いくものになるまでV1は消すな。
  満足したら指示する」と指示があった。指示が出るまで、削除は1行も行わない。
  準備(棚卸し・移植・手順の確認)だけを進める。
- WP-12完了。
- ownerがV2画面を比較確認。
- CI green。
