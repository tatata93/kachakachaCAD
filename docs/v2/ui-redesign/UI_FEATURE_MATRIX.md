...
| F-GPT | 製作 → 近似 → GPT版 | 面・許容・部材数・最小幅・方向、部材下見と最大/RMS、組立率、確定/型紙 | GptApproximation / OcctGptFabrication / V2GptFabricationTool | AT-GPT-F001/002、HP-GPT-F01 | 実装中・PC全体未検証 |
