...
| 10 | Tree / View selection divergence | `src/apps/cad_next/V2SelfTestExplorer.cpp`: "HP-EX-03 3D と一覧の選択が両方向に同期する" | EXISTING |
| 11 | 個別 visibility 不足 | `src/apps/cad_next/V2SelfTestExplorer.cpp`: "HP-EX-02 ◉ で1つずつ出し隠しでき、取り消しで戻る" | EXISTING |
...
| 13 | Origin が最上段でない | `src/apps/cad_next/V2SelfTestExplorer.cpp`: "HP-EX-01 一覧の節は正本の順で原点が先頭" | EXISTING |
