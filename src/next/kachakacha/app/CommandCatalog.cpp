...
const std::vector<CommandDescriptor>& CommandCatalog()
{
    ...
    static const std::vector<CommandDescriptor> table = {
        ...
        {"wire.trim", "トリム", CommandMode::Tool, "trim", "X",
            ...
            "境目は画面の全部の線。円は交点の間が消えて円弧に。続けて押せます(Esc でやめる)。", true,
            {"AT-WIR-006"}},
        {"wire.extend", "延長", CommandMode::Tool, "extend", "E",
            SelectionPredicate::Always, "",
            "線の端の近くに置くと、いちばん近い線まで伸びる先が見えます。押すと伸びます"
            "(2 本選んでから押せば、2 本目を相手にする昔の道)。", true,
            {"AT-WIR-006"}},
        {"wire.split", "分割", CommandMode::Tool, "split", "",
            SelectionPredicate::Always, "",
            "線の上に置くと、いちばん近い交点に × が出ます。押すとそこで 2 本に分かれます"
            "(2 本以上選んでから押せば、1 本目を残りで切る昔の道)。", true,
            {"AT-WIR-001"}},
        {"wire.move", "移動", CommandMode::Tool, "move", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "選んだ線・部品を、2点で示した分だけ動かします(元の線は残さず、元の部品は隠します)。", true,
            {"AT-WIR-006"}},
        {"wire.copy", "コピー", CommandMode::Tool, "copy", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "選んだ線・部品を、2点で示した分だけ離して複製します。元は残します。", true,
            {"AT-WIR-006"}},
        {"wire.mirror", "ミラー複製", CommandMode::Tool, "mirror", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "2点で引いた線を鏡にして、選んだ線・部品を複製します。元は残します。", true,
            {"AT-WIR-006"}},
        ...
        {"part.boolean_intersect", "交差", CommandMode::Dialog, "boolean_intersect", "",
            ...
            "重ならなければ断ります。", true,
            {"AT-EXT-007"}},
        {"part.move", "部品の移動", CommandMode::Tool, "move", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "選んだ部品を、2点で示した分だけ動かします(元の部品は隠します。何個でも 1 回で戻る)。", true,
            {"AT-EXT-001"}},
        {"part.copy", "部品のコピー", CommandMode::Tool, "copy", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "選んだ部品を、2点で示した分だけ離して写します。元の部品は残します。", true,
            {"AT-EXT-001"}},
        {"part.mirror", "部品のミラー", CommandMode::Tool, "mirror", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "2点で引いた線を含み作業平面に垂直な面を鏡にして、部品を写します。元の部品は残します。", true,
            {"AT-EXT-001"}},
        {"part.rotate", "部品の回転", CommandMode::Tool, "rotate", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "中心・始まりの向き・終わりの向きの3点で、作業平面の法線まわりに部品を回します(元は隠します)。", true,
            {"AT-EXT-001"}},
        {"part.array_linear", "部品を直線に並べる", CommandMode::Dialog, "array_line", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "選んだ部品を、決めた間隔と向きで個数ぶん並べます(元を含む。1 回で戻る)。", false,
            {"AT-EXT-001"}},
        {"part.array_circular", "部品を円に並べる", CommandMode::Dialog, "array_circle", "",
            SelectionPredicate::OneOrMoreParts, "部品を1つ以上選んでください。",
            "選んだ部品を、中心と全体の角度で個数ぶん円に並べます(元を含む。1 回で戻る)。", false,
            {"AT-EXT-001"}},
        ...
        {"fabrication.gpt_create", "GPT版近似", CommandMode::Dialog, "fab_new", "",
            SelectionPredicate::Always, "近似する面を選んでください。",
            "外周を保って一方向曲げの部材へ近似し、偏差と型紙を確認します。", true, {"AT-GPT-F001", "AT-GPT-F002"}},
