...
| AT-GEO-001 | 済 | tests_v2/guide_surface_tests.cpp(入力検査)+ tests_v2/kernel_surface_tests.cpp(面積・穴・境界曲線種類)+ e4e9c37: 線から面(loop_faces_tests 15、自己試験 HP-LF-01〜03。PC f526c00 で通過) |
