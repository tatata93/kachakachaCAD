...
const std::vector<CommandDescriptor>& CommandCatalog()
{
    ...
    static const std::vector<CommandDescriptor> table = {
        ...
        {"view.display_settings", "表示設定", CommandMode::Dialog, "display", "",
            ...
            {"AT-UIX-010"}},
        {"view.stage_all", "すべて出す", CommandMode::Instant, "stage_all", "Ctrl+1",
            SelectionPredicate::Always, "",
            "グリッドも補助線も出します。形は変わりません。", false,
            {"AT-UIX-010"}},
        {"view.stage_no_grid", "グリッドを消す", CommandMode::Instant, "stage_grid",
            "Ctrl+2", SelectionPredicate::Always, "",
            "グリッドだけ消します。形は変わりません。", false,
            {"AT-UIX-010"}},
        {"view.stage_no_construction", "補助線も消す", CommandMode::Instant,
            "stage_plain", "Ctrl+3", SelectionPredicate::Always, "",
            "グリッドも補助線も消して、出来上がりだけ見ます。形は変わりません。", false,
            {"AT-UIX-010"}},
