...
const std::vector<CommandDescriptor>& CommandCatalog()
{
    ...
    static const std::vector<CommandDescriptor> table = {
        ...
        {"wire.offset", "オフセット", CommandMode::Instant, "offset", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "作図面の上で、指定距離だけ離した線を複製します。元の線は残します。", true,
            {"AT-WIR-006"}},
        {"wire.meet", "2線を交点まで", CommandMode::Instant, "meet", "",
            SelectionPredicate::TwoWireChains, "鎖を2つ選んでください。",
            "2本の直線を交点までトリムまたは延長します。", true,
            {"AT-WIR-006"}},
        {"entity.set_datum", "基準線に設定", CommandMode::Instant, "datum", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "選んだ線を、寸法や作図の基準として扱います。形は変わりません。", true,
            {"AT-DOC-005"}},
        {"entity.clear_datum", "基準解除", CommandMode::Instant, "datum_clear", "",
            SelectionPredicate::OneOrMoreWires, "ワイヤーを1つ以上選んでください。",
            "選んだ線の基準設定を解除します。形は変わりません。", true,
            {"AT-DOC-005"}},
