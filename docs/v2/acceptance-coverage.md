...
| AT-UIX-011 | 済 | src/next/kachakacha/app/CommandCatalog.cpp と tests_v2/command_catalog_tests.cpp(93件を双方向で突き合わせ。表示名・記号・案内・受入IDの有無、ショートカットの重複、camera操作が文書を変えないことを見る)+ tests_v2/manual_tests.cpp(`docs/manual.html` が93件を各1回説明し、V2画像と実用見本を参照することを見る) |
